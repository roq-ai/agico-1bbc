...
function BusinessListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<BusinessInterface[]>(
    ...
    () =>
      getBusinesses({
        relations: ['user', 'appointment.count', 'cash_box.count', 'product.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('cash_box', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>cash_box</Th>}
